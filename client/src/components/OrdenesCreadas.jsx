...
import { obtenerTotalOrdenes, editarTodasOrdenes } from "../redux/actions";

import "./FormCrud.sass";

export const OrdenesCreadas = () => {
  const dispatch = useDispatch();
  const ordenes = useSelector((store) => store.ordenes.totalOrdenes);

  let arrayOrdenesCreadas = ordenes
    ? ordenes.filter((orden) => orden.estado === "creada")
    : false;
  ...
  const editarOrder = (id) => {
    dispatch(editarTodasOrdenes(id, "procesando"));
